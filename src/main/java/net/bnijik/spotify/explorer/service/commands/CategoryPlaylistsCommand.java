...
public class CategoryPlaylistsCommand implements SpotifyExplorerCommand {
    ...
    public CategoryPlaylistsCommand(AuthSpotifyService authSpotifyService, MusicSpotifyService musicSpotifyService, UserConsoleService view, @SuppressWarnings("rawtypes") Map<String, MusicItemCache> itemCaches, String commandString) {
